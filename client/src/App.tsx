...
//           <h1 className="text-2xl font-bold text-white">EduNexus</h1>
//         </div>
//       </div>
//     </div>
//   );
...
//               <div className=" mx-auto rounded-2xl shadow-xl p-8 mb-16 transform transition-all hover:shadow-2xl duration-300">
//                 <div className="flex items-center justify-center mb-6">
//                   <div className="bg-[#f0e8ff] p-3 rounded-full mr-4">
//                     <svg
...
//                     >
//                       <span className="bg-[#f0e8ff] p-1 rounded-md mr-2">
//                         <svg
...
//                   className={`flex items-center justify-center bg-gradient-to-r from-[#8a4fff] to-[#a069ff] hover:from-[#7a3fee] hover:to-[#9059ef] text-white text-lg px-8 py-3 rounded-xl shadow-lg transition-all duration-300 ${
//                     !selectedBranch || !selectedSubject
//                       ? "opacity-70 cursor-not-allowed"
//                       : "hover:shadow-[0_5px_20px_rgba(138,79,255,0.4)]"
//                   }`}
...
//                     whileHover={{ scale: 1.05 }}
//                     whileTap={{ scale: 0.95 }}
//                     className="px-6 py-2 border border-purple-500 text-purple-600 rounded-lg hover:bg-purple-50 transition-all"
//                     onClick={() => {
//                       setShowDifficultySelection(false);
//                     }}
//                   >
...
//                     className={`bg-gradient-to-r from-[#8a4fff] to-[#a069ff] text-white px-6 py-2 rounded-lg shadow-md transition-all ${
//                       !selectedDifficulty
//                         ? "opacity-70 cursor-not-allowed"
//                         : "hover:shadow-lg"
//                     }`}
...
//         id={id}
//         type="button"
//         className={`w-full flex items-center justify-between border-2 border-[#e0d4ff] bg-white h-12 px-4 rounded-xl transition-all text-left ${
//           disabled
//             ? "opacity-60 cursor-not-allowed"
//             : "cursor-pointer hover:border-[#8a4fff]"
//         }`}
...
//       {isOpen && (
//         <div className="absolute z-10 w-full mt-1 bg-white border border-[#e0d4ff] rounded-xl shadow-lg max-h-60 overflow-auto">
//           {options.length > 0 ? (
//             options.map((option) => (
//               <div
//                 key={option.value}
//                 className="px-4 py-2 cursor-pointer hover:bg-[#f0e8ff] hover:text-[#8a4fff]"
...
function App() {
  ...
  const [showDifficultySelection, setShowDifficultySelection] = useState<boolean>(false);
  const [selectedBranch, setSelectedBranch] = useState<string>("");
  const [showEngineeringPath, setShowEngineeringPath] = useState(false);
const [showEresources, setShowEresources] = useState(false);
  const [selectedDifficulty, setSelectedDifficulty] = useState<string>("");
  const [quizState, setQuizState] = useState<QuizState>({
    questions: [],
    currentQuestionIndex: 0,
